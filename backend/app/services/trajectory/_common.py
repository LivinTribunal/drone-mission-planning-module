"""shared helpers used across segment_builder and coordinator (and imported by tests)."""
...
from app.utils.geo import elevation_angle, opposite_bearing, point_at_distance
...
def _apply_terrain_delta(
    ...
    PAPI location (done in coordinator). this function adjusts each waypoint
